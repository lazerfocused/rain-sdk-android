...
dependencies {
    ...
    // the consumer's compile classpath; a Portal-only app links rain-portal and nothing else.
...
mavenPublishing {
    coordinates("io.github.spartan-quanhongtran", "rain-portal", libs.versions.rain.sdk.get())
