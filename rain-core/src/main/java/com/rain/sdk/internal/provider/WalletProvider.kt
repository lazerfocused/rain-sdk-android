...
interface WalletProvider {
    /** Stable identifier for this provider (Turnkey / Portal / Privy / custom). */
    val id: ProviderId

    /**
     * Optional behaviours this provider advertises; see [Capability] and the optional
     * capability interfaces (e.g. [RainTypedDataSignerProvider]).
     */
