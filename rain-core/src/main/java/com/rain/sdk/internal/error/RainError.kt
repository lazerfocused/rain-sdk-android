...
sealed class RainError(
  ...
  /**
   * The active provider does not implement the requested operation (e.g. a stub/scaffold
   * provider, or a provider lacking an optional capability). Carries the method name.
   * Mirrors iOS `RainSDKError.notImplemented` (RAIN_503).
   */
