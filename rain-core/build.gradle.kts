...
dependencies {
    ...
    // Turnkey lives inside rain-core for now (com.rain.sdk.turnkey) per the modular-architecture
...
mavenPublishing {
    coordinates("io.github.spartan-quanhongtran", "rain-core", libs.versions.rain.sdk.get())
