...
// Shared across :rain-core / :rain-portal / :rain-privy so androidx @RestrictTo(LIBRARY_GROUP)
// treats them as one library group (sibling modules may use the adapter kit; apps may not).
group = "xyz.rain"
...
mavenPublishing {
    coordinates("xyz.rain", "rain-core", libs.versions.rain.sdk.get())
